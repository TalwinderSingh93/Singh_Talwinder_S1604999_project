...
public class PlannedWorksActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener
{
    ...
    LinkedList <PlannedWorksClass> List = null;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        List  = new LinkedList<PlannedWorksClass>();
        ...
        dateSelection.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view)
            {
                ...
                DatePickerDialog dialog = new DatePickerDialog(PlannedWorksActivity.this,
        ...
        public void run()
        {
            ...
            PlannedWorksActivity.this.runOnUiThread(new Runnable()
            {
                public void run() {
                    ...
                    List = parseDataPlannedWorks(resMain);

...
public class IncidentsActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener
{
    ...
    LinkedList <IncidentsClass> List = null;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        List  = new LinkedList<IncidentsClass>();
        ...
        dateSelection.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view)
            {
                ...
                DatePickerDialog dialog = new DatePickerDialog(IncidentsActivity.this,
    ...
    private class Task implements Runnable
    {
        ...
        public void run()
        {
            ...
            IncidentsActivity.this.runOnUiThread(new Runnable()
            {
                public void run() {
                    ...
                    List = parseDataIncidents(resMain);
